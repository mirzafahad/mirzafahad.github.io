...
My workstation was badly in need of a major overhaul. In an attempt to bring <font color="red">c</font><font color="green">o</font><font color="purple">l</font><font color="blue">o</font><font color="yellow">r</font> at my workspace I made an audio visualizer using LED strips. 
...
The microphone solution would have been okay, but as it would react to any sound I bet it would  end up as annoying. Also none of those products could distinguish audio spectrums. So I had to go out and build this for myself. 
