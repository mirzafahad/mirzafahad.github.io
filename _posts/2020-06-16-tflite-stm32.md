...
# Why Rewrite the Example
  Here is an excerpt from the GitHub: 
...
* This is the first reason I wanted to rewrite the example. I am mostly interested in STM32 microcontrollers. I am heavily invested in their [ecosystem](https://www.st.com/en/ecosystems/stm32cube.html). From IDE, Monitoring tool, CubeMx to their HAL libraries. I wanted to get away from all those abstractions and keep the example simple so that it is easier to follow.
