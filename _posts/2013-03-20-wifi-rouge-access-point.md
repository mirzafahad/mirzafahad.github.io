...
{: .box-warning}
**Note:** I am **NOT** going to show how to decode packets, or how to make sense of any packets. That is out of this tutorial's scope.

# What is Man-in-the-middle attack?  
Man-in-the-middle attack is a form of cybercttack where the attacker sits in between two parties who think that they are communicating with each other without knowing that all their communication grows through the attacker, who can simply listens to their conversation or even can alter their communication. [Wikipedia](https://en.wikipedia.org/wiki/Man-in-the-middle_attack#Example) has a great example:
