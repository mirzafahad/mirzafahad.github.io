...
After the LightDriverStruct comes the hardware-specific parameters. The X10-specific data includes the house code and the unit number. The combination of the two values identifies a specific light. These

constants are part of the X10 driver interface. Let's look at the X10LightDriver.h:
