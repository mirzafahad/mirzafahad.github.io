...
The procedures that Romans followed are explained in detail [here](http://turner.faculty.swau.edu/mathematics/materialslibrary/roman/) and [here](http://scienceblogs.com/goodmath/2006/08/16/roman-numerals-and-arithmetic/). My solution can be found [here](https://github.com/mirzafahad/code_kata_roman_calculator), written in C.
...
The code can be found [here](http://github.com/mirzafahad/codeKata_RomanCalculator).
