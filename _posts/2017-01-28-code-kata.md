...
{: .box-note}
**Note:** It seems converting roman numbers is a '[Project Euler Problems](http://projecteuler.net/)' ([Problem 89](http://projecteuler.net/problem=89)). The math behind the conversion is explained [here](http://www.mathsisfun.com/roman-numerals.html).
...
### Roman Calculator
Now, let's get back to being an actual Romanian. The Roman Calculator library has two global functions, **add2romanNum** and  **sub2romanNum**. If you haven't visited the [algorithm links](http://turner.faculty.swau.edu/mathematics/materialslibrary/roman/) already, please do so. I will copy the example from that page:
